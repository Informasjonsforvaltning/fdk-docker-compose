...
#push
(cd ../fdk && git checkout develop && git push --follow-tags origin)

#fdk-api-harvester
#create
(cd ../fdk-api-harvester && git checkout develop && git pull && npm run release)
#push
(cd ../fdk-api-harvester && git checkout develop && git push --follow-tags origin)

#concept-catalogue
#create
(cd ../concept-catalogue && git checkout develop && git pull && npm run release)
#push
(cd ../concept-catalogue && git checkout develop && git push --follow-tags origin)

#concept-catalogue-gui
#create
(cd ../concept-catalogue-gui && git checkout develop && git pull && npm run release)
#push
(cd ../concept-catalogue-gui && git checkout develop && git push --follow-tags origin)
